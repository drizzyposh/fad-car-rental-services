...
## Overview
A responsive Car rental website that shows various models of cars available for rent. I made use of Firebase Authentication to for the backend of the website. Each of the user datas are stored in firestore database.
